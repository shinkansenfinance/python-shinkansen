from Crypto.Math.Numbers import Integer  # pycryptodrome
from Crypto import Random
from hashlib import sha512
from base64 import b64encode, b64decode
import binascii

# Primes from Modular Exponential (MODP) Diffie-Hellman groups (from RFCs like
# RFC 3526)
...
p = Integer.from_bytes(PRIMES[15])
k1 = Integer.random(max_bits=3071)
k2 = Integer.random(max_bits=3071)
rut = "11.111.111-1"
hashed_rut_int = Integer.from_bytes(sha512(rut.encode()).digest())
opaque_rut = pow(hashed_rut_int, k1, p)
opaque_rut_string = binascii.b2a_base64(opaque_rut.to_bytes()).decode()
opaque_rut_from_string = Integer.from_bytes(binascii.a2b_base64(opaque_rut_string))
assert opaque_rut == opaque_rut_from_string
